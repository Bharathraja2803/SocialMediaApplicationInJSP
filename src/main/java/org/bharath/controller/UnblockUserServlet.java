...
public class UnblockUserServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean isAccountUnlocked = usersDaoImpl.blockAndUnblock(users.getUserId_(), targetUserId, 'n');
		
		if(!isAccountUnlocked){
			MainCentralizedResource.LOGGER.warning("Something went wrong in unblocking the account");
